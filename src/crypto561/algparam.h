...
public:
	...
	bool GetVoidValue(const char *name, const type_info &valueType, void *pValue) const;
...
{
public:
	GetValueHelperClass(const T *pObject, const char *name, const type_info &valueType, void *pValue, const NameValuePairs *searchFirst)
...
private:
	const T *m_pObject;
	const char *m_name;
	const type_info *m_valueType;
	void *m_pValue;
	bool m_found, m_getValueNames;
};

template <class BASE, class T>
GetValueHelperClass<T, BASE> GetValueHelper(const T *pObject, const char *name, const type_info &valueType, void *pValue, const NameValuePairs *searchFirst=NULL, BASE *dummy=NULL)
{
	return GetValueHelperClass<T, BASE>(pObject, name, valueType, pValue, searchFirst);
}

template <class T>
GetValueHelperClass<T, T> GetValueHelper(const T *pObject, const char *name, const type_info &valueType, void *pValue, const NameValuePairs *searchFirst=NULL)
{
...
typedef bool (CRYPTOPP_API * PAssignIntToInteger)(const type_info &valueType, void *pInteger, const void *pInt);
CRYPTOPP_DLL extern PAssignIntToInteger g_pAssignIntToInteger;

CRYPTOPP_DLL const type_info & CRYPTOPP_API IntegerTypeId();
...
protected:
	...
	virtual void AssignValue(const char *name, const type_info &valueType, void *pValue) const =0;
...
public:
	...
	void AssignValue(const char *name, const type_info &valueType, void *pValue) const
	{
